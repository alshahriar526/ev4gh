            ...
            <div class="container-fluid p-5">
                ...
                <div class="main-timeline">
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-content">
                            <p class="description">Navigating through the challenges posed by COVIS-19 pandemic in 2020, the EV2020 venture took place in 2021 in Dubai in November 2021 with support from Mohammed Bin Rashid School of Government, Dubai. 14 new Emerging Voices from around the world travelled to Dubai to attend the EV4GH 2020 edition in person, with others joined remotely across time differences and hemispheres.</p>
                        </div>
                    </div>
                    <div class="timeline">
                        <div class="icon"></div>
                        ...
                        <div class="timeline-content">
                            <p class="description">The 8th edition of the Emerging Voices for Global Health (EV4GH) program, EV2022, was held in Colombia, in sync with the Seventh Global Symposium on Health Systems Research (HSR2022) in Bogota (31 Oct-4 Nov). 60 people, including participants and facilitators of 31 different nationalities, attended and facilitated the program.</p>
                        </div>
                    </div>
                </div>
            </div>
